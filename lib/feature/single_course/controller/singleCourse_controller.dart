...
class SingleCourseController {
  ...
  onPaymentSuccess({required double price,required double discount,required String courseName,required String subName,required Map<dynamic,dynamic>response,required WidgetRef ref}){
