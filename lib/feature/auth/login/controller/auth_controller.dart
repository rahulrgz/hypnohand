...
class AuthController extends StateNotifier<bool>{
  ...
  void signInWithGoogle({
    ...
    state=true;
    final user=await _authRepository.singInwithGoogle( context: context);
    state=false;
    user.fold((l){
  ...
  upDateGoogleSignInDoc({
   ...
   required WidgetRef ref,
    ...
    final user=await _authRepository.updateGoogleSignInDoc(state: state??'',country: country??'',phone: phone??'',name: name??'');
...
//   signInWithEmailAndPassword({required String email,required String password,required BuildContext context})async{
//      _authRepository.signInWithEmailAndPassword(email: email, password: password,context: context);
//   }

//   createUserWithEmailAndPassword({required String name,required String email,required String number,required String password,required BuildContext context ,required WidgetRef ref,required String state,required String country})async{
//     final res=await _authRepository.createUserWithEmailAndPassword(email: email, password: password,number: number,name: name,state: state,country: country);
