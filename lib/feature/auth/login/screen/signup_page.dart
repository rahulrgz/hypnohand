...
class _SignUp_pageState extends ConsumerState<SignUp_page> {
  ...
  signInUser()async{
    ...
    ref.read(authControllerProvider.notifier).createUserWithEmailAndPassword(ref: ref,email: _emailcontroller.text, password: passwordController.text, context: context, name:_namecontroller.text,number: _numbercontroller.text);
                  ...
                  content: Text("password length must be greater than 6"))):
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          ...
                          content: Text("your password does not match")))
                                  ...
                                  : _emailcontroller.text.isNotEmpty&&_emailcontroller.text.contains('@')&&_emailcontroller.text.contains('.com')?
                      signInUser():
